...
// @version      0.1
// @description  Generation of statistical data for CouchDB's complexity query level 4 
// @include      http://localhost:5984/dbo/_design/testqueries/_view/complexityQuery_lvl4*
...
console.log("Start");
var localURL = 'http://wwwlab.iit.his.se/b15matki/query_results/couchDB_complexityQuery_lvl4.php';
var scrapedData = [];
...
function nextQuery() {
        if (queryNr === null || queryNr == "undefined" || queryNr == "NaN" || queryNr == "") {
            ...
            responseTime();
            window.location.replace("http://localhost:5984/dbo/_design/testqueries/_view/complexityQuery_lvl4?startkey=%222000-01-01T00:00:00Z%22&endkey=%222005-12-31T00:00:00Z%22");
        }
        else if (queryNr < 100) {
