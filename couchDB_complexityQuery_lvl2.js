...
// @version      0.1
// @description  Generation of statistical data for CouchDB's complexity query level 2 
// @include      http://localhost:5984/dbo/_design/testqueries/_view/complexityQuery_lvl2*
...
console.log("Start");
var localURL = 'http://wwwlab.iit.his.se/b15matki/query_results/couchDB_complexityQuery_lvl2.php';
var scrapedData = [];
...
function nextQuery() {
        if (queryNr === null || queryNr == "undefined" || queryNr == "NaN" || queryNr == "") {
            ...
            responseTime();
            window.location.replace("http://localhost:5984/dbo/_design/testqueries/_view/complexityQuery_lvl2");
        }
        else if (queryNr < 100) {
